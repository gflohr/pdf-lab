...
export namespace SFNTTable {
	...
	export type GPOSLookupSingleV1 = GPOSTable.GPOSLookupSingleV1;
	export type GPOSLookupSingleV2 = GPOSTable.GPOSLookupSingleV2;
	export type GPOSLookupSingle = GPOSTable.GPOSLookupSingle;
	export type GPOSLookupPairV1 = GPOSTable.GPOSLookupPairV1;
	export type GPOSLookupPairV2 = GPOSTable.GPOSLookupPairV2;
	export type GPOSLookupPair = GPOSTable.GPOSLookupPair;
	export type GPOSLookupCursive = GPOSTable.GPOSLookupCursive;
	export type GPOSLookupMarkToBase = GPOSTable.GPOSLookupMarkToBase;
	export type GPOSLookupMarkToLigature = GPOSTable.GPOSLookupMarkToLigature;
	export type GPOSLookupMarkToMark = GPOSTable.GPOSLookupMarkToMark;
	export type GPOSLookupContext = GPOSTable.GPOSLookupContext;
	export type GPOSLookupChainingContext = GPOSTable.GPOSLookupChainingContext;
	export type GPOSLookupExtension = GPOSTable.GPOSLookupExtension;
	export type GPOSLookupTable = GPOSTable.GPOSLookupTable;
	export type GPOSV1_0 = GPOSTable.GPOSV1_0;
	export type GPOSV1_1 = GPOSTable.GPOSV1_1;
	export type GPOS = GPOSTable.GPOS;

	export type GSUBLookupSingleV1 = GSUBTable.GSUBLookupSingleV1;
	export type GSUBLookupSingleV2 = GSUBTable.GSUBLookupSingleV2;
	export type GSUBLookupSingle = GSUBTable.GSUBLookupSingle;
	export type GSUBLookupMultiple = GSUBTable.GSUBLookupMultiple;
	export type GSUBLookupAlternate = GSUBTable.GSUBLookupAlternate;
	export type GSUBLookupLigatureSet = GSUBTable.GSUBLookupLigatureSet;
	export type GSUBLookupLigature = GSUBTable.GSUBLookupLigature;
	export type GSUBLookupReverseChaining = GSUBTable.GSUBLookupReverseChaining;
	export type GSUBLookupTable = GSUBTable.GSUBLookupTable;
